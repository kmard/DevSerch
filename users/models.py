...
class Profile(models.Model):
    ...
    profile_image = models.ImageField(null=True,blank=True,upload_to='profiles/',default='images/default.png')
    ...
    social_linkdin = models.CharField(max_length=100,blank=True,null=True) 
